            ...
            <form action="{{ route('anak.update', $anak->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-4">
                        ...
                        @if($anak->foto_anak)
                            <div class="mb-4">
                                <img src="{{ asset('storage/' . $anak->foto_anak) }}" alt="Foto {{ $anak->nama_lengkap }}" class="h-40 w-auto object-cover rounded-md">
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-4">
                        ...
                        @if($anak->foto_kk)
                            <div class="mb-4">
                                <img src="{{ asset('storage/' . $anak->foto_kk) }}" alt="Foto KK {{ $anak->nama_lengkap }}" class="h-40 w-auto object-cover rounded-md">
                                <p class="text-xs text-gray-500 mt-1">Foto KK saat ini</p>
                            </div>
                        @endif
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                            <div class="space-y-1 text-center">
