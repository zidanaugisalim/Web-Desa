...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('anak', function (Blueprint $table) {
            ...
            $table->dropColumn(['tempat_lahir', 'rt_rw', 'kecamatan', 'kabupaten', 'provinsi', 'kode_pos', 'no_telepon', 'catatan_khusus']);
        });
    }
    ...
    public function down(): void
    {
        Schema::table('anak', function (Blueprint $table) {
            ...
            $table->string('rt_rw', 10)->after('alamat');
            $table->string('kecamatan', 50)->after('rt_rw');
            $table->string('kabupaten', 50)->after('kecamatan');
            $table->string('provinsi', 50)->after('kabupaten');
            $table->string('kode_pos', 10)->after('provinsi');
            $table->string('no_telepon', 15)->after('kode_pos');
            $table->text('catatan_khusus')->nullable()->after('foto_kk');
